...
{
    public class DisplayGameViewWithRank : DisplayDataViewBase
    {
        ...
        public DisplayGameViewWithRank()
        {
        ...
        public void Refresh()
        {
            if (_currGroup != null)
            {
                ...
                {
                    _lineItemsBox.Children.Add(new DisplayGameViewWithRankLineItem(new DisplayGameViewWithRankLineItem.LineItem(line), height));
                }
            }
        }
    }
