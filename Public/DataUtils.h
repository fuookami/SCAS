...
namespace DataUtils
{
	...
	public:
		...
		inline static bool fromData2Bool(const Data &data) { return _fromData<bool>(data); }

		inline static Data toData(const float value) { return _toData(value); }
		inline static float fromData2Float(const Data &data) { return _fromData<float>(data); }

		inline static Data toData(const double value) { return _toData(value); }
		inline static double fromData2Double(const Data &data) { return _fromData<double>(data); }

		inline static Data toData(const uint8 value) { return _toData(value); }
		inline static int8 fromData2Int8(const Data &data) { return _fromData<int8>(data); }
		inline static uint8 fromData2UInt8(const Data &data) { return _fromData<uint8>(data); }

		inline static Data toData(const uint16 value) { return _toData(value); }
		inline static int16 fromData2Int16(const Data &data) { return _fromData<int16>(data); }
		inline static uint16 fromData2UInt16(const Data &data) { return _fromData<uint16>(data); }

		inline static Data toData(const uint32 value) { return _toData(value); }
		inline static int32 fromData2Int32(const Data &data) { return _fromData<int32>(data); }
		inline static uint32 fromData2UInt32(const Data &data) { return _fromData<uint32>(data); }

		inline static Data toData(const uint64 value) { return _toData(value); }
		inline static int64 fromData2Int64(const Data &data) { return _fromData<int64>(data); }
		inline static uint64 fromData2UInt64(const Data &data) { return _fromData<uint64>(data); }
	...
	private:
		...
		template <typename T>
		static const T _fromData(const Data &data)
		{
			static const uint8 DataLength(sizeof(T));
	...
	inline const Data fromBool(const bool value) { return DataUtils::_DataUtils::toData(value); }

	inline const float toFloat(const Data &data) { return DataUtils::_DataUtils::fromData2Float(data); }
	inline const Data fromFloat(const float value) { return DataUtils::_DataUtils::toData(value); }

	inline const double toDouble(const Data &data) { return DataUtils::_DataUtils::fromData2Double(data); }
	inline const Data fromDouble(const double value) { return DataUtils::_DataUtils::toData(value); }

	inline const int8 toInt8(const Data &data) { return DataUtils::_DataUtils::fromData2Int8(data); }
	inline const Data fromInt8(const int8 value) { return DataUtils::_DataUtils::toData(static_cast<uint8>(value)); }
	inline const uint8 toUInt8(const Data &data) { return DataUtils::_DataUtils::fromData2UInt8(data); }
	inline const Data fromUInt8(const uint8 value) { return DataUtils::_DataUtils::toData(value); }

	inline const int16 toInt16(const Data &data) { return DataUtils::_DataUtils::fromData2Int16(data); }
	inline const Data fromInt16(const int16 value) { return DataUtils::_DataUtils::toData(static_cast<uint16>(value)); }
	inline const uint16 toUInt16(const Data &data) { return DataUtils::_DataUtils::fromData2UInt16(data); }
	inline const Data fromUInt16(const uint16 value) { return DataUtils::_DataUtils::toData(value); }

	inline const int32 toInt32(const Data &data) { return DataUtils::_DataUtils::fromData2Int32(data); }
	inline const Data fromInt32(const int32 value) { return DataUtils::_DataUtils::toData(static_cast<uint32>(value)); }
	inline const uint32 toUInt32(const Data &data) { return DataUtils::_DataUtils::fromData2UInt32(data); }
	inline const Data fromUInt32(const uint32 value) { return DataUtils::_DataUtils::toData(value); }
