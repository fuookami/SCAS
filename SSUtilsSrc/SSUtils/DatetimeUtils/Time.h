...
namespace SSUtils
{
	namespace Datetime
	{
		class SSUtils_API_DECLSPEC Time
		{
		public:
			Time(void);
		...
		class SSUtils_API_DECLSPEC TimeDuration
		{
		public:
			TimeDuration(void);
		...
		SSUtils_API_DECLSPEC Time getLocalTime(void);
		SSUtils_API_DECLSPEC Time getTimeAfterLocalTime(const TimeDuration &duration);
		SSUtils_API_DECLSPEC Time getTimeBeforeLocalTime(const TimeDuration &duration);
	};
};

SSUtils_API_DECLSPEC const bool operator<(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::Time &rhs);
SSUtils_API_DECLSPEC const bool operator<=(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::Time &rhs);
SSUtils_API_DECLSPEC const bool operator>(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::Time &rhs);
SSUtils_API_DECLSPEC const bool operator>=(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::Time &rhs);
SSUtils_API_DECLSPEC const bool operator==(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::Time &rhs);
...
SSUtils_API_DECLSPEC const bool operator<(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const bool operator<=(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const bool operator>(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const bool operator>=(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const bool operator==(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);
...
SSUtils_API_DECLSPEC const SSUtils::Datetime::Time operator+(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const SSUtils::Datetime::Time operator-(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const SSUtils::Datetime::TimeDuration operator-(const SSUtils::Datetime::Time &lhs, const SSUtils::Datetime::Time &rhs);

SSUtils_API_DECLSPEC const SSUtils::Datetime::TimeDuration operator+(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);
SSUtils_API_DECLSPEC const SSUtils::Datetime::TimeDuration operator-(const SSUtils::Datetime::TimeDuration &lhs, const SSUtils::Datetime::TimeDuration &rhs);

SSUtils_API_DECLSPEC std::ostream &operator<<(std::ostream &os, const SSUtils::Datetime::Time &time);
SSUtils_API_DECLSPEC std::ostream &operator<<(std::ostream &os, const SSUtils::Datetime::TimeDuration &timeDuration);
