...
namespace SCAS.Domain.UserContext
{
        ...
        : DomainEventBase<DomainEventValue, OrganizationRegisterUnapprovedEventData>
    {
        ...
        public override string Message { get { return string.Format("Register of organization {0} to region {1} unapproved by {2}", form.Org.Info.Name, form.RegisteredRegion.Info.Name, form.Examination.Examiner.Info.Name); } }
