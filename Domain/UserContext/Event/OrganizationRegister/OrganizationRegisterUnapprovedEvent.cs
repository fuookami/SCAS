...
namespace SCAS.Domain.UserContext
{
    ...
    public class OrganizationRegisterUnapprovedEvent
        : UserContextArtificialEventBase<DomainEventValue, OrganizationRegisterUnapprovedEventData>
    {
        ...
        internal OrganizationRegisterUnapprovedEvent(Person op, OrganizationRegisterForm targetForm, IExtractor extractor = null)
            : base(op, UserContextEvent.OrganizationRegisterUnapproved, SCASEventType.Model, SCASEventLevel.Common, SCASEventPriority.Common, new OrganizationRegisterUnapprovedEventData(targetForm), extractor)
        {
            form = targetForm;
        }
