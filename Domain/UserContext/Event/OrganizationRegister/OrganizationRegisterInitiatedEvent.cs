...
namespace SCAS.Domain.UserContext
{
    ...
    public class OrganizationRegisterInitiatedEvent
        : UserContextArtificialEventBase<DomainEventValue, OrganizationRegisterInitiatedEventData>
    {
        ...
        internal OrganizationRegisterInitiatedEvent(Person op, OrganizationRegisterForm newForm, IExtractor extractor = null)
            : base(op, UserContextEvent.OrganizationInfoModified, SCASEventType.Model, SCASEventLevel.Common, SCASEventPriority.Common, new OrganizationRegisterInitiatedEventData(newForm), extractor)
        {
            form = newForm;
        }
