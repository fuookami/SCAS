...
namespace SCAS.Domain.UserContext
{
        ...
        : DomainEventBase<DomainEventValue, OrganizationRegisterInitiatationEventData>
    {
        ...
        public override string Message { get { return string.Format("Register of organization {0} to region {1} initiated by {2}, code {3}", form.Org.Info.Name, form.RegisteredRegion.Info.Name, form.Info.Initiator.Info.Name, form.Info.PrefixCode); } }
